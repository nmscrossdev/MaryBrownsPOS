  ...
  render() {
    ...
    return (
      ...
      <div className="portrait">
        <div className='ordersummary-parret'>
          <div>
          <Navbar />
            <div className="category-header-row">
              <div className="category-header-col">
                <p className="title">{LocalizedLanguage.ordersummary}</p>
              </div>
              ...
              <div className="cart-items">
                ...
                {checkList && checkList.ListItem && checkList.ListItem.map((product, index) => {
                    ...
                    <div className="item"  key={index}>
                      ...
                      <div className="row">
                        <label className="number-input-container">
                          <div click={this.decrementDefaultQuantity} className="svg-container left">
                          ...
                          <div click={this.incrementDefaultQuantity} className="svg-container right">
                  ...
                  <div className="item note">
                    <div className="col">
                      <p className="prod-name">{LocalizedLanguage.note}</p>
