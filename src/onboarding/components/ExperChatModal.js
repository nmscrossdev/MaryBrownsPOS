...
class ExpertChatModal extends React.Component {
    render() {
        return (
            <div id="EXPERTSchat" className="modal fade" role="dialog">
                                                                    ...
                                                                    <div className="row card-body-center">
                                                                        <div className="col-sm-7 col-lg-7">
                                                                            <div className="card text-center card-basic card-expert-view">
                                                                                <div className="card-header no-border">
                                                                                    <h3>{LocalizedLanguage.ChatwithusLive}</h3>
                                                                                </div>
                                                                        ...
                                                                        <div className="col-sm-5 col-lg-5">
                                                                            <div className="card text-center card-basic card-shadow card-booking">
                                                                                ...
                                                                                <div className="card-body card-body-space-15">
                                                                                    <h3 className="font-lg font-light">{LocalizedLanguage.ChangeIframeGoeshere}</h3>
