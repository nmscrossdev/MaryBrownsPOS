            ...
            (isMobileOnly == true) ?
                ...
                : (ActiveUser.key.isSelfcheckout == true) ?
                    <div className="app-list-view app-list-responsive">
                        <div key={"attribute" + "All"} className="app app-success" data-attribute-id="All">
                            <div className="app-body app-body-content " onClick={() => this.redirect()}>
                                <h1 className="app-title text-truncate text-center bg_green">
                        ...
                        {
                            //  category for self checkout
                            this.props.childCategory && this.props.childCategory.map((item, index) => {
                                return (
                                    <div key={"childCategory" + index} id={`${index}_sub_category`} className="app app-primary inner-sub-category" data-attribute-id={item.attribute_id} data-id={`subcat_${item.id}`} onClick={() => this.tileFilterData(item.Code, "inner-sub-category", index)} >
                                        <div className="app-body app-body-content ">
...

                        {
                            this.props.SubAttributeList && this.props.SubAttributeList.map((item, index) => {
                                return (
                                    <div key={"SubAttributeList" + index} id={`${index}_sub_attribute`} className="app app-primary inner-sub-attribute" data-attribute-id={item.attribute_id} data-id={`subattr_${item.id}`} onClick={() => this.tileFilterData(item.Code, "inner-sub-attribute", index, item.taxonomy.replace("pa_", ""))}>
                                        <div className="app-body app-body-content ">
                                            <h1 className="app-title text-truncate text-center">
                                                <a href="javascript:void(0)">
                                                    <Markup content={item.Value}></Markup>
                        ...
                        }
                        {
                            this.props.childSubAttributeList && this.props.childSubAttributeList ?
                                <div className="app app-primary inner-sub-attribute">
                                    <div className="app-body app-body-content " onClick={() => this.tileFilterData(this.props.childSubAttributeList.attribute_slug, "inner-sub-attribute", this.props.childSubAttributeList.attribute_slug, this.props.childSubAttributeList.parent_attribute.replace("pa_", ""))} id={`${this.props.childSubAttributeList.attribute_slug}_sub_attribute`}>
                                        <h1 className="app-title text-truncate text-center">
                                            <a href="javascript:void(0)">
                        ...
                        {this.props.subchildCategory && this.props.subchildCategory && !this.props.subchildCategory.Subcategories ?
                            <div className="app app-primary inner-sub-category" >
                                <div className="app-body app-body-content" onClick={() => this.tileFilterData(this.props.subchildCategory.category_slug, "inner-sub-category", this.props.subchildCategory.category_slug)} id={`${this.props.subchildCategory.category_slug}_sub_category`} >
                                    <h1 className="app-title text-truncate text-center">
                                        <a href="javascript:void(0)" >
                            ...
                            this.props.subchildCategory && this.props.subchildCategory && this.props.subchildCategory.Subcategories.length > 0 ?
                                this.props.subchildCategory.Subcategories && this.props.subchildCategory.Subcategories.map((item, index) => {
                                    return (
                                        <div key={"subchildCategory" + index} id={`${index}_sub_category`} className="app app-primary inner-sub-category" data-attribute-id={item.attribute_id} data-id={`subcat_${item.id}`} onClick={() => this.tileFilterData(item.Code, "inner-sub-category", index)} >
                                            <div className="app-body app-body-content">
                                                <h1 className="app-title text-truncate text-center">
                                                    <a href="javascript:void(0)" onClick={() => this.checkSubCategoryList(item)}>
                                                        <Markup content={item.Value}></Markup>
